...
#if (CONFIG_SENSORS_BMI088_BMP388 == 1) || (CONFIG_SENSORS_BMI088_SPI == 1)
  #include "sensors_bmi088_bmp388.h"
#endif

#if CONFIG_SENSORS_MPU9250_LPS25H == 1
  #include "sensors_mpu9250_lps25h.h"
#endif

#if CONFIG_SENSORS_BOSCH == 1
...
#if CONFIG_SENSORS_BMI088_BMP388 == 1
  {
...
#endif
#if CONFIG_SENSORS_BMI088_SPI == 1
  {
